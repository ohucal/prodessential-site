...
export default function KitModal() {
  ...
  return (
    <div className="modal-overlay active" id="kitModalOverlay" onClick={(e) => { if (e.target === e.currentTarget) closeKit(); }}>
      <div className="modal modal--kit" role="dialog" aria-modal="true">
        <button className="modal-close" onClick={closeKit} aria-label="Close">
